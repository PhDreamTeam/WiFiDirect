...
/**
 * Created by DR AT on 02/07/2015.
 *
 */
/*
...
public class WifiLayer {
    ...
    /**
     * See {@link Settings.Secure#WIFI_NUM_OPEN_NETWORKS_KEPT}.
     */
    ...
    public boolean connectToNetwork(AccessPointState state) {
        ...
        if (config == null) {
            ...
            if (config == null) {
                ...
                Log.e(TAG, "error: error_connecting");
                return false;
            }
            /*
    ...
    public boolean forgetNetwork(AccessPointState state) {
        ...
        if (!managerSaveConfiguration()) {
            Log.e(TAG, "error(R.string.error_saving);");
            return false;
        }
        return true;
    }
...
//    }
    ...
    private void refreshStatus(AccessPointState ap, DetailedState detailedState) {
        final WifiInfo wifiInfo = mWifiManager.getConnectionInfo();
    ...
    private void handleNetworkStateChanged(NetworkInfo info, String bssid) {
        ...
        if (ap != null && info.isConnectedOrConnecting()) {
           ...
           error("wifi_generic_connection_error");
