...
public final class AccessPointState implements Comparable<AccessPointState>, Parcelable {
    ...
    public String getHumanReadableSecurity() {
        if (security.equals(OPEN)) return "wifi_security_open";
        else if (security.equals(WEP)) return "wifi_security_wep";
        else if (security.equals(PSK)) return "wifi_security_psk";
        else if (security.equals(EAP)) return "wifi_security_eap";
    ...
    public static String getWifiConfigurationSecurity(WifiConfiguration wifiConfig) {
        ...
        //DEBUG DR AT
//        else if (!TextUtils.isEmpty(wifiConfig.enterpriseConfig.getPassword())) {
//            Log.d("AccessPointState", "ESTA NO CODIGO EAP ADAPTADO... getWifiConfigurationSecurity(...)");
//            return EAP;
//        }
//        else if (!TextUtils.isEmpty(wifiConfig.eap.value())) {
//            return EAP;
//        }
        return OPEN;
    }
...
//        }
        //DEBUG DR AT
        Log.d("AccessPointState", "Retir�mos as coisas que davam erro...");
...
//            if (!TextUtils.isEmpty(mPassword)) {
//                config.enterpriseConfig.setPassword(convertToQuotedString(mPassword));
//// DEBUG DR AT
...
//            }
    ...
    private String getVerboseSecurity() {
        if (WEP.equals(security)) {
            return "wifi_security_verbose_wep";
        } else if (PSK.equals(security)) {
            return "wifi_security_verbose_psk";
        } else if (EAP.equals(security)) {
            return "wifi_security_verbose_eap";
        } else {
            return null;
        }
    }
