...
final public class WifiApControl {
...

    {
        ...
        wifiAPStates.put(WIFI_AP_STATE_ENABLED, "WIFI_AP_STATE_ENABLED");
        wifiAPStates.put(WIFI_AP_STATE_FAILED, "WIFI_AP_STATE_FAILED ");
    }


//	public static final int WIFI_AP_STATE_DISABLING = WIFI_AP_STATE_DISABLING;
...
//	public static final int STATE_FAILED    = WIFI_AP_STATE_FAILED;
    ...
    /**
     * AT DR Get string state description
     *
     * @return state string name
     */
    public String getWifiApStateStr() {
        int state = getState();
        if (state == -1)
            return null;
        return wifiAPStates.get(state);
    }

    /**
     * getStateStr is a commodity function alias for getWifiApStateStr.
     */
